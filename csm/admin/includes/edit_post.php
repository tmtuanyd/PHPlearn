...
if(isset($_POST['update_post'])){
    ...
    echo "<p class='bg-success'>Post Update. <a href='../post.php?post_id=$the_post_id'> View Post</a> or <a href='post.php'>Edit More Post</a></p>";
}
?>
...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <select name="post_status" id="">
        ...
        <option value="unpublished" <?php if($post_status === "unpublished") echo "selected"?>>unpublished</option>
    </select>
    <div class="form-group">
